...
* [VectorVision bring WASM to GPU](https://github.com/SamGinzburg/VectorVisor)
* [Overhead of creating threads in various WebAssembly environment](https://github.com/abrown/bench-thread-spawn)
* [Hoot WebAssembly toolchain](https://gitlab.com/spritely/guile-hoot)
* [Weakening WebAssembly](https://github.com/WebAssembly/spec/blob/main/papers/oopsla2019.pdf)
* [WIT as an IDL](https://github.com/bytecodealliance/wit-bindgen)
* [wasmc a WebAssembly interpreter](https://github.com/mcuking/wasmc)
* [Fastly Cloud Platorm](https://www.fastly.com/de/)
* [WebR - R in the Browser, statistic language](https://docs.r-wasm.org/webr/latest/)
* [OCaml toolchain](https://github.com/ocamlpro/owi)
* [Binaryen Toolchain and Compiler](https://github.com/WebAssembly/binaryen)
